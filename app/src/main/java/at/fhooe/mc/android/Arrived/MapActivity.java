...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback , GoogleApiClient.OnConnectionFailedListener {
    ...
    private void geoLocate() {
        ...
        if (list.size() > 0) {
            ...
            Log.d(TAG, "geoLocate: found a Locaton: " + address.toString());
    ...
    private void moveCamera(LatLng latLng, float zoom, String title) {
        ...
        hideSoftKeyboard(); //hide Soft Keyboard not working
    }
    ...
    private void initMap() {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.activityMaps_Maps);
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                if (mLocationPermissionGranted) {
                    ...
                    init();
                    //todo check other UI Settings IMPORTANT!!!
    ...
    private void hideSoftKeyboard() {   //hier ist noch ein struggle!
